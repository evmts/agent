...
<criteria>
- [ ] Feature flag controls ghost commit feature
- [ ] Ghost commit created after each completed turn
- [ ] Commit message includes turn number and summary
- [ ] All modified and new files included
- [ ] Commit refs stored in session metadata
- [ ] Revert to any turn via commit ref
- [ ] Per-turn diff retrievable
- [ ] Cleanup on session close (optional squash)
- [ ] Sensitive files excluded (patterns)
- [ ] Works in non-git directories (graceful degradation)
</criteria>
