...
<criteria>
- [ ] Ctrl+V/Cmd+V pastes clipboard images
- [ ] Image saved to temp file
- [ ] Attachment shown in composer
- [ ] Multiple images supported
- [ ] Remove attachment before sending
- [ ] Image included in message API call
- [ ] Supports PNG, JPEG, GIF formats
- [ ] Error shown for unsupported formats
- [ ] Works on macOS, Linux (X11/Wayland)
- [ ] Temp files cleaned up on send/cancel
- [ ] Text paste still works when no image
</criteria>
