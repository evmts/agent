    ...
    private var agentHeaderBar: some View {
        HStack(spacing: DesignSystem.Spacing.md) {
            ...
            HStack(spacing: DesignSystem.Spacing.sm) {
                ...
                HStack(spacing: 4) {
                    Circle()
                        .fill(appState.webState.automation.isConnected ? DesignSystem.Colors.success : DesignSystem.Colors.textTertiary.opacity(0.3))
                        .frame(width: 6, height: 6)
            ...
            HStack(spacing: DesignSystem.Spacing.lg) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    HStack(spacing: 6) {
                        ...
                        Circle()
                            .fill(appState.webState.automation.isConnected ?
                                  DesignSystem.Colors.success :
                                  DesignSystem.Colors.textTertiary.opacity(0.3))
                            .frame(width: 6, height: 6)

                        Button("snapshot") {
                            core.handleEvent(.browserSnapshot)
                        }
                        .buttonStyle(MiniButtonStyle())
                        .disabled(!appState.webState.automation.isConnected)

                        Button("screenshot") {
                            core.handleEvent(.browserScreenshot)
                        }
                        .buttonStyle(MiniButtonStyle())
                        .disabled(!appState.webState.automation.isConnected)
                    }
