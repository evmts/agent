IMPLEMENTATION PHASE — Ticket: {props.ticketId} — {props.ticketTitle}
...
1. Implement plan FULLY — nothing unfinished
2. Documentation-driven: write/update docs FIRST
3. Test-driven: write tests FIRST, then implementation
4. Atomic git commits: ✨ feat, 🧪 test, 🐛 fix, 📋 docs, ♻️ refactor, ⚡ perf, 🔧 chore
...
- Common APIs LLMs get wrong: std.json, std.ArrayList, std.HashMap — verify against source
