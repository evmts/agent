...
pub const struct_utmp = extern struct {
    ...
    ut_time: c_long = @import("std").mem.zeroes(c_long),
};
...
pub extern fn pidlock([*c]const u8, c_int, [*c]pid_t, [*c]const u8) c_int;
pub extern fn ttylock([*c]const u8, c_int, [*c]pid_t) c_int;
pub extern fn ttyunlock([*c]const u8) c_int;
pub extern fn ttyaction(tty: [*c]u8, act: [*c]u8, user: [*c]u8) c_int;
pub const struct_iovec = opaque {};
pub extern fn ttymsg(?*struct_iovec, c_int, [*c]const u8, c_int) [*c]u8;
pub const struct_lastlog = extern struct {
    ll_time: time_t = @import("std").mem.zeroes(time_t),
...
pub const __ENVIRONMENT_MAC_OS_X_VERSION_MIN_REQUIRED__ = @import("std").zig.c_translation.promoteIntLiteral(c_int, 150301, .decimal);
pub const __ENVIRONMENT_OS_VERSION_MIN_REQUIRED__ = @import("std").zig.c_translation.promoteIntLiteral(c_int, 150301, .decimal);
...
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include/sys/_symbol_aliasing.h:977:9
pub const __DARWIN_ALIAS_STARTING_MAC___MAC_15_5 = @compileError("unable to translate C expr: unexpected token ''");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include/sys/_symbol_aliasing.h:983:9
...
pub const BSDLY = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00008000, .hex);
pub const VTDLY = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00010000, .hex);
pub const OFDEL = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00020000, .hex);
...
pub const BS1 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00008000, .hex);
pub const VT0 = @as(c_int, 0x00000000);
pub const VT1 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00010000, .hex);
...
pub const MDMBUF = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00100000, .hex);
